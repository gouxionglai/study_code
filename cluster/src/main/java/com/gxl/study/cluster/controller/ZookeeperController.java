package com.gxl.study.cluster.controller;

import com.gxl.study.cluster.config.ZkClient;
...
public class ZookeeperController {
    ...
    public String create(@PathVariable Integer type,@PathVariable String znode,@RequestBody String nodeData){
        znode = "/" + znode;
        try {
